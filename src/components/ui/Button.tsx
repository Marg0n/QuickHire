...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles: Record<ButtonVariant, string> = {
    1: "border border-[#4640DE] bg-primary text-[#000] hover:bg-[#4640DE] hover:text-[#fff] ",
    ...
    5: "border border-[#9d3533] bg-[#DE3B37] text-[#fff] hover:bg-secondary hover:text-[#000] dark:hover:bg-transparent dark:hover:text-[#abc2d3] ",
